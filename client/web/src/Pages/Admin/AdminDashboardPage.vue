  ...
  <div>
    ...
    <section class="section">
      <header :class=" lang==='ar' ? 'section__header direction-rtl' :'section__header direction-ltr'">
        <h2 class="section__title">{{ $t('AdminDashboard.Body.title') }} {{ user.user_name }}</h2>
      </header>
      <!--   for Admin user     -->
      <ul class="team">
...
export default {
  ...
  data() {
    return {
      ...
      DashboardInfoCardSection1ForADMIN_AR: [
        {
          Path: '/v2/main/admin/create/controller/type',
          ClassColorBorder: 'photo__item photo__item-bg1Color',
      ...
      DashboardInfoCardSection2ForADMIN_EN: [
        {
      ...
      DashboardInfoCardSection2ForADMIN_AR: [
        {
          Path: '/v2/main/admin/create/processor',
          ClassColorBorder: 'photo__item photo__item-bg1Color',
