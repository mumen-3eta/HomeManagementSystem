...
public class addLocationClass extends Dialog implements
    ...
    public addLocationClass(Activity a) {
        super(a);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_yes:
                ...
                Call<locationResponseAdmin> call = jsonApi.addControllerLocation(Splash.sp.getString("Cookie", ""), location);
                call.enqueue(new Callback<locationResponseAdmin>() {
                    ...
                    public void onResponse(Call<locationResponseAdmin> call, Response<locationResponseAdmin> response) {
                        ...
                        if (response.body().getDetail().equals("Controller location added Successfully")){
                             Toast.makeText(label.getContext(), "Controller location added Successfully", Toast.LENGTH_SHORT).show();
