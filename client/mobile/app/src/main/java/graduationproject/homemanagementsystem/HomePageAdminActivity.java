...
public class HomePageAdminActivity extends AppCompatActivity {
    ...
    private void getControllerLocations() {
        ...
        call.enqueue(new Callback<locationResponse>() {
            ...
            public void onResponse(Call<locationResponse> call, Response<locationResponse> response) {
                if (!response.isSuccessful()){
                    ...
                    try {
                        ...
                        toast.makeText(HomePageAdminActivity.this, message.substring(10, message.length()-2), Toast.LENGTH_SHORT).show();
                        getControllers();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<locationResponse> call, Throwable t) {
                getControllers();
                toast.makeText(HomePageAdminActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                location = true;
                if (user && type && location && processor && controller){
                    HomepageProgressBar.setVisibility(View.INVISIBLE);
                }
            ...
            public void onResponse(Call<controllerResponse> call, Response<controllerResponse> response) {
                ...
                if (response.body().getDetail().equals("user controllers data collected Successfully ")){
                    if (response.body().getConnectionData().toString().equals("[no controllers connected yet]")){
                        ...
                        adapter = new deviceAdapter(HomePageAdminActivity.this, controllers);
    ...
    public void goAdminTools(View view){
        home_logo.setBackground(null);
    ...
    public void logoutAction(View view){
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                Activity homePageActivity = HomePageAdminActivity.this;
    ...
    public void viewProcessors(View view) {
        if (numberOfProcessors.getText().toString().equals("0")) {
            ...
            redirectActivity(HomePageAdminActivity.this, ViewProcessors.class);
        }
    }
}