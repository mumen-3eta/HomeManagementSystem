<template>
  ...
  <!--          <div-->
  <!--              class="anim2 col-12 col-md-4 col-lg-6 d-flex justify-content-center align-items-center flex-column right__content-device">-->
  <!--            <div class="container-device-right d-flex justify-content-center align-items-center flex-column">-->
  ...
  <!--            <div class="container-device-info-left">-->
  <!--              <div>-->
  <!--                <p>Number Device : {{ $route.params.Device_id }}</p>-->
  <!--              </div>-->
  <!--              <div class="container-device-info d-flex flex-column">-->
  <!--                <div class="d-flex justify-content-start align-items-start">-->
  <!--                  <p class="labelLocation">Location |</p>-->
  <!--                  <p class="nameLabelLocation">living rome </p>-->
  <!--                </div>-->
  <!--                <div class=" d-flex justify-content-start align-items-start">-->
  <!--                  <p class="labelLocation">Type |</p>-->
  ...
  <!--                </div>-->
  <!--                &lt;!&ndash;       if  need last input active active it (checkbox active)         &ndash;&gt;-->
  <!--                &lt;!&ndash;                <div class="form-check form-switch isActiveInput justify-content-end align-items-center">&ndash;&gt;-->
  <!--                &lt;!&ndash;                  <input id="flexSwitchCheckDefault" class="form-check-input" type="checkbox">&ndash;&gt;-->
  <!--                &lt;!&ndash;                  <label class="form-check-label  pl-2" for="flexSwitchCheckDefault">Active</label>&ndash;&gt;-->
  <!--                &lt;!&ndash;                </div>&ndash;&gt;-->
  <!--              </div>-->
...
export default {
  ...
  //       .from(anim3, {opacity: 0, duration: 1, y: 50}, '-=0.7')
  //
  // },
  // components: {
  //   TopNavBar,
...
<!--<style scoped>-->
<!--@import "../../assets/temp/Temp_Old_Style__needDelete/MainPageStyle/_DeviceInfoStyle.css";-->
<!--</style>-->
