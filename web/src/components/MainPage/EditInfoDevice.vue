<template>
  ...
  <!--    <TopNavBar/>&lt;!&ndash;  end top nav bar    &ndash;&gt;-->
  <!--    <LeftNavBar/>&lt;!&ndash;  end Left nav bar    &ndash;&gt;-->
  ...
  <!--                   required type="text">-->
  <!--          </div>-->
  <!--          &lt;!&ndash;          <div class="col-md-6 anim5">&ndash;&gt;-->
  <!--          &lt;!&ndash;            <label class="form-label" for="inputStatus">Status<span class="text-danger px-1">*</span></label>&ndash;&gt;-->
  <!--          &lt;!&ndash;            <select id="inputStatus" v-model.trim="deviceInfo.status" class="form-select" required>&ndash;&gt;-->
  <!--          &lt;!&ndash;              &lt;!&ndash;              <option value="-1">Choose One...</option>&ndash;&gt;&ndash;&gt;-->
  <!--          &lt;!&ndash;              <option selected value="0">Not Active</option>&ndash;&gt;-->
  ...
  <!--        &lt;!&ndash;        <div v-if="this.deviceInfoAdd" class="container py-5">&ndash;&gt;-->
  <!--        &lt;!&ndash;          <div class="row">&ndash;&gt;-->
  <!--        &lt;!&ndash;            <div class="col">&ndash;&gt;-->
  <!--        &lt;!&ndash;              <p>{{ deviceInfoAdd.nameDevice }}</p>&ndash;&gt;-->
  <!--        &lt;!&ndash;              <p>{{ deviceInfoAdd.nameLocation }}</p>&ndash;&gt;-->
  <!--        &lt;!&ndash;              <p>{{ deviceInfoAdd.nameType }}</p>&ndash;&gt;-->
  <!--        &lt;!&ndash;              <p>{{ deviceInfoAdd.status | Status }} </p>&ndash;&gt;-->
  <!--        &lt;!&ndash;            </div>&lt;!&ndash; End Of col&ndash;&gt;&ndash;&gt;-->
  <!--        &lt;!&ndash;          </div>&lt;!&ndash; End Of row&ndash;&gt;&ndash;&gt;-->
  <!--        &lt;!&ndash;        </div>&lt;!&ndash; End Of container&ndash;&gt;&ndash;&gt;-->
...
<!--<style scoped>-->
<!--@import "../../assets/temp/Temp_Old_Style__needDelete/MainPageStyle/_addDeviceStyle.css";-->
<!--</style>-->
